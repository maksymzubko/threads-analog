const PostThreadSkeleton = () => {
    return (
        <div role={"status"}
             className={"mt-10 border-dark-3 border-[1px] flex items-start gap-4 p-5 rounded-2xl animate-pulse"}>
            ...
            <div className={"w-full flex flex-col justify-start gap-5 relative"}>
                <div className={"h-[300px] rounded-2xl bg-dark-3"}></div>
                ...
                <div className={"flex justify-between"}>
                    ...
                    <div className={"h-[40px] rounded-2xl w-[120px] bg-dark-3"}/>
                </div>
            </div>
        </div>
    );
