      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-base-medium text-gray-1 whitespace-nowrap overflow-hidden overflow-ellipsis max-w-[120px] md:max-w-[140px] 2xl:max-w-[180px]">
              @{username}
            </p>
          </div>
        </div>
