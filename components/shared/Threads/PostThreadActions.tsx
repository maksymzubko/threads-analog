  ...
  return (
    <div className={'flex items-center gap-2'}>
      <div ref={block} className={'cursor-pointer relative'}>
        <Image
          priority
          onClick={handleStateEmoji}
          src={'/assets/emoji.png'}
          className={'invert transition ease-in-out hover:grayscale-[1px]'}
          alt={'Emoji'}
          width={32}
          height={32}
        />
      ...
      <div className={'cursor-pointer'}>
        <ImageIcon
          className={`h-[28px] w-[28px] transition ease-in-out ${
            filesLength >= 1 && 'opacity-40 cursor-auto'
          } hover:opacity-40`}
          color={'#b7b7b7'}
