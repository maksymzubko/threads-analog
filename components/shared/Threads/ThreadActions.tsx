    ...
    <div className={`mt-5 flex flex-col gap-3`}>
      <div className={'flex justify-between md:justify-start gap-3.5'}>
        ...
        >
          <div
            className={
              'flex items-center justify-center h-[36px] sm:h-[36px] w-[32px] sm:w-[36px] relative transition ease-in-out hover:bg-[#5c5c7b33] rounded-full'
            }
          >
            <Image
              priority
        ...
        >
          <div
            className={
              'flex items-center justify-center h-[36px] sm:h-[36px] w-[32px] sm:w-[36px] transition ease-in-out hover:bg-[#5c5c7b33] rounded-full relative'
            }
          >
            <Image
              priority
          ...
          {(isComment || isMain) && commentsLength > 0 && (
            <p>{commentsLength}</p>
          )}
        </Link>
        ...
        <div
          className={
            'flex items-center justify-center h-[36px] sm:h-[36px] w-[32px] sm:w-[36px] transition ease-in-out hover:bg-[#5c5c7b33] rounded-full relative [&>*]:text-dark-3'
          }
        >
