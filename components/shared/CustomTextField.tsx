...
const CustomTextField = ({
  ...
  const [results, setResults] = useState<{ users: any[]; isNext: boolean }>({
    users: [],
    isNext: false,
  })
    ...
    <>
      <MentionsInput
        ...
        style={{
          '&multiLine': {
            control: {
              outline: 'none',
              fontSize: '16px',
              maxHeight: isComment ? '300px' : 'auto',
              minHeight: isComment ? '150px' : '300px',
              border: 'none',
            },
          },
          suggestions: {
        ...
        customSuggestionsContainer={(children) => {
          ...
          return (
            <div className={`w-[300px] p-3 bg-dark-4`}>
      ...
      >
        <Mention
          ...
          renderSuggestion={(
            ...
            const user = results.users.find(
              (u) => u._id.toString() === suggestion.id.toString()
            )
            return (
              <UserCard
